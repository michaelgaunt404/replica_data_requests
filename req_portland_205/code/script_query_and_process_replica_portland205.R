...
query_network_trip_using_bbox(
  bb_network_layer = 'req_portland_205/data/network_poly_both_bridges_union.gpkg'
  ,bb_sa_layer = 'req_portland_205/data/network_poly_both_bridges_union.gpkg'
