...
query_network_trip_using_bbox(
  bb_network_layer = 'req_austin/data/network_poly_20231107.gpkg'
  ,bb_sa_layer = 'req_austin/data/network_poly_20231107.gpkg'
...
query_network_trip_using_bbox(
  bb_network_layer = 'req_florida_tampa/data/network_poly_20231107.gpkg',
  bb_sa_layer = 'req_florida_tampa/data/network_poly_20231107.gpkg',
  ...
  prefix_origin = "start",
  prefix_dest = "end",
  file_destination = "req_florida_tampa/data",
  query_network = T,
  max_record = Inf
)
...
replicaToolkitR::query_replica_mvmnt_patterns(
  network_table = "replica-customer.south_atlantic.south_atlantic_2021_Q4_network_segments"
  ,trip_table = "replica-customer.south_atlantic.south_atlantic_2021_Q4_thursday_trip"
  ,mode_type = c('PRIVATE_AUTO')
  ,customer_name = "replica-customer"
  ,jitter_factor = 0.003
  ,save_location = "req_florida_tampa/data"
  ,mvmnt_df = data.frame(mvmnt_desc = c("brandon_pky_west","brandon_pky_east")
