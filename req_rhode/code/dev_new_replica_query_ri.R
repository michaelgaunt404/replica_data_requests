...
generators = mapedit::drawFeatures() %>%  st_transform(4326)

generators = generators %>%
  mutate(Name = c("Providence", "Quanset"))

# study_area = tigris::states("RI") %>% st_transform(4326)



network_table = "replica-customer.northeast.northeast_2021_Q4_network_segments"
trip_table = "replica-customer.northeast.northeast_2021_Q4_thursday_trip"
